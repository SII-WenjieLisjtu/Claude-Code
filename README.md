...
- [源码结构导读](docs/source-structure.md)

### 6. 安全背景与上下文
- [公开快照与供应链安全背景](docs/security-context.md)
...
感谢那些让这份工程样本得以被认真研究的人，也感谢所有愿意把注意力放回到系统设计本身的人。对这类仓库来说，真正长期有价值的，始终是它背后的工程思想。

## 贡献者

| 贡献者 | 贡献内容 |
|---|---|
| **SII-WenjieLisjtu** | 仓库整理、中文 README 与专题文档撰写、源码架构分析与文档分层设计 |
| **SII-zyj** | 参与仓库整理、源码结构梳理、阅读路线与分析思路补充 |
